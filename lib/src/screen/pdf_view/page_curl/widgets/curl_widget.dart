...
import 'package:ebook/src/screen/pdf_view/page_curl/clipper/curl_background_clipper.dart';
import 'package:ebook/src/screen/pdf_view/page_curl/clipper/curl_backside_clipper.dart';
...
import 'package:ebook/src/screen/pdf_view/page_curl/painters/curl_shadow_painter.dart';
...
class _CurlWidgetState extends State<CurlWidget> {
  ...
  void onDragCallback(final details) {
   // print("local pos ${details.localPosition}");
