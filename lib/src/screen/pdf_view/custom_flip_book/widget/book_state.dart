...
class FlipBookState extends State<FlipBook>
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      //print("leve list ${controller.leaves.first.pages}");
  ...
  Widget leafBuilder(BuildContext context, Leaf leaf) {
    ...
    print("builder ${controller.isCenterAlign}");
    final animationVal = leaf.animationController.value;
    print("build1 $animationVal ${leaf.pages.first} and ${leaf.pages.last}");
    ...
    print("build2 ${pages.first} ${pages.last} $pages");
  ...
  void _onDragStart(DragStartDetails details) {
    ...
    controller.isCenterAlign = false;
