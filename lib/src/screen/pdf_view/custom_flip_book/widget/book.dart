...
import 'package:ebook/src/screen/pdf_view/custom_flip_book/aspect_ratio_fraction.dart';
...
import 'package:ebook/src/screen/pdf_view/custom_flip_book/widget/page_builder.dart';
import 'package:ebook/src/screen/pdf_view/custom_flip_book/widget/page_delegate/page_builder_delegate.dart';
import 'package:ebook/src/screen/pdf_view/custom_flip_book/widget/page_delegate/page_delegate.dart';
import 'package:ebook/src/screen/pdf_view/custom_flip_book/widget/page_delegate/page_list_delegate.dart';
...
class FlipBook extends StatefulWidget {
  ...
  static bool totalPagesValidation(int? totalPages) {
    print("total pagess : $totalPages");
    return totalPages != null && totalPages >= 4 && totalPages % 2 == 0;
  }
